...
- claim_status accuracy: — (real API run pending; synthetic baseline 0.35)
- issue_type accuracy: — (real API run pending)
- object_part accuracy: — (real API run pending)
- severity accuracy: — (real API run pending)
